...
from model.MultiModel_Semi.MutilModel_Semi import MultiModel_Semi
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    save_path = os.path.join(args.save_dir, args.save_name,args.num_labels,args.version)
    log_save_path = os.path.join(args.save_dir, args.save_name,args.num_labels,args.version)
    ...
    logger = get_logger(args.save_name, log_save_path, logger_level)
    ...
    model = MultiModel_Semi(_net_builder,
                        args.num_classes,
                        args.ulb_loss_ratio,
    ...
    train_dset = SSL_Dataset(args, alg='MultiModel_Semi', name=args.dataset, train=True,
                             num_classes=args.num_classes, data_dir=args.data_dir)
    lb_dset, ulb_dset = train_dset.get_ssl_dset(args.num_labels_in)

    _eval_dset = SSL_Dataset(args, alg='MultiModel_Semi', name=args.dataset, train=False,
                             num_classes=args.num_classes, data_dir=args.data_dir)
    ...
    for epoch in range(args.epoch):
        # logger.info(f"...................epoch: {epoch} training is starting.........................")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='SemiModel_wideresnet_HTRU_01') # 'Model_Semi_var'加入了方差 'Model_Semi_similarity'加入了样本相似度
    ...
    parser.add_argument('--num_train_iter', type=int, default=50000,
    ...
    parser.add_argument('--num_labels', type=str, default='800_0226')
    parser.add_argument('--num_labels_in', type=int, default=800)
    ...
    # networks = ['WideResNet']    #'multimodel18'
    networks = ['multimodel18']    #'multimodel18'

    # networks = ['WideResNetVar','ResNet18','ResNet34',
