...
def net_builder(net_name, from_name: bool, net_conf=None, is_remix=False):
    ...
    if from_name:
        ...
        if net_name == 'WideResNet':
            ...
            import model.nets.wrn_var as net
            builder = getattr(net, 'build_WideResNetVar')()
        elif net_name == 'ResNet18':
            import model.nets.resnet as net
            ...
            import model.nets.senet as net
            builder = getattr(net, 'build_SEResNet18')()
        elif net_name == 'SEResNet34':
            import model.nets.senet as net
            builder = getattr(net, 'build_SEResNet34')()
        elif net_name == 'SEResNet50':
            import model.nets.senet as net
            builder = getattr(net, 'build_SEResNet50')()
        elif net_name == 'RegNetY':
            import model.regnet.regnet as net
            builder = getattr(net, 'build_RegNetY')()
        elif net_name == 'efficientnet':
            import model.nets.efficientnet as net
            builder = getattr(net, 'build_efficientnet')()
        elif net_name == 'MobileNet':
            import model.nets.mobilenet as net
            builder = getattr(net, 'build_MobileNet')()
        elif net_name == 'MobileNetV2':
            import model.nets.mobilenetv2 as net
            builder = getattr(net, 'build_MobileNetV2')()
        elif net_name == 'CotNet26':
            import model.CotNet.cotnet_resnet as net
            builder = getattr(net, 'build_CoTResNet26')()
        elif net_name == 'CotNet50':
            import model.CotNet.cotnet_resnet as net
            builder = getattr(net, 'build_CoTResNet50')()
        elif net_name == 'multimodel18':
            import model.MultiModel_Semi.mutimodel as net
            builder = getattr(net, 'build_multimodel18')()
        else:
